...
public class ContainerWorkbench_MC1_20_R2 extends IContainerWorkbench {
	...
	static void initReflection() throws ClassNotFoundException, NoSuchFieldException, SecurityException, NoSuchMethodException,
		...
		playerInventoryField = entityHuman.getDeclaredField("cn");
	...
	ContainerWorkbench_MC1_20_R2(Player player) throws ClassNotFoundException {
		try {
			this.player = player;
