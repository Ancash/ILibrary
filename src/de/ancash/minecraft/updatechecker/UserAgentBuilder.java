 ...
 * "JEFF-Media-GbR-SpigotUpdateChecker/[version]" followed by all added
 * parameters.
 */
public class UserAgentBuilder {
	...
	/**
	 * Adds the Server version. For example "ServerVersion/git-Paper-584 (MC:
	 * 1.16.5)"
	 *
	 * @return UserAgentBuilder instance
	 */
	...
	/**
	 * Returns the Spigot User ID of the user who downloaded the plugin. Only works
	 * for paid plugins from SpigotMC.org. For example "SpigotUID/175238"
	 *
	 * @return UserAgentBuilder instance
	 */
	...
	/**
	 * Returns whether this copy of the .jar is a paid plugin downloaded from
	 * SpigotMC.org. For example "Paid/true"
	 *
	 * @return UserAgentBuilder instance
	 */
