package de.ancash.minecraft.anvilgui;
...
import de.ancash.minecraft.anvilgui.version.VersionMatcher;
import de.ancash.minecraft.anvilgui.version.VersionWrapper;
...
public class AnvilGUI {
	...
	/**
	 * An {@link Consumer} that is called when the {@link Slot#INPUT_LEFT} slot has
	 * been clicked
	 */
	private final Consumer<Player> inputLeftClickListener;
	/**
	 * An {@link Consumer} that is called when the {@link Slot#INPUT_RIGHT} slot has
	 * been clicked
	 */
	 ...
	 * @param biFunction A {@link BiFunction} that is called when the player clicks
	 ...
	 * @param itemText         The name of the item in the first slot of the
	 *                         anvilGui
	 * @param inputLeft        The material of the item in the first slot of the
	 *                         anvilGUI
	 ...
	 */
	private AnvilGUI(Plugin plugin, Player player, String inventoryTitle, String itemText, ItemStack inputLeft,
			ItemStack inputRight, boolean preventClose, Consumer<Player> closeListener,
		...
		public void onInventoryClick(InventoryClickEvent event) {
			if (event.getInventory().equals(inventory)
				...
				if (event.getRawSlot() == Slot.OUTPUT) {
					...
					final Response response = completeFunction.apply(clicker,
	...
	public static class Builder {
		...
		/**
		 * An {@link BiFunction} that is called when the anvil output slot has been
		 * clicked
		 */
		 ...
		 *
		 * @param closeListener An {@link Consumer} that is called when the anvil GUI is
		 *                      closed
		 * @return The {@link Builder} instance
		 ...
		 *
		 * @param inputLeftClickListener An {@link Consumer} that is called when the
		 *                               first input slot is clicked
		 * @return The {@link Builder} instance
		 */
		 ...
		 *
		 * @param inputRightClickListener An {@link Consumer} that is called when the
		 *                                second input slot is clicked
		 * @return The {@link Builder} instance
		 */
		 ...
		 *
		 * @param completeFunction An {@link BiFunction} that is called when the user
		 ...
		 * @throws IllegalArgumentException when the onComplete function, plugin, or
		 *                                  player is null
		 */
		public AnvilGUI open(Player player) {
			...
			return new AnvilGUI(plugin, player, title, itemText, itemLeft, itemRight, preventClose, closeListener,
	...
	public static class Response {
		 ...
		 *
		 * @param text The text that is to be displayed to the user, which can be null
		...
		/**
		 * Returns an {@link Response} object for when the anvil GUI is to display text
		 * to the user
		 *
		 * @param text The text that is to be displayed to the user
		 * @return An {@link Response} object for when the anvil GUI is to display text
		 *         to the user
		 */
		...
		/**
		 * Returns an {@link Response} object for when the GUI should open the provided
		 * inventory
		 *
