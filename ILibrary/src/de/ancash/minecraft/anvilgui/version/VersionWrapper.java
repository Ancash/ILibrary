...
public interface VersionWrapper {
	...
	/**
	 * Sends PacketPlayOutOpenWindow to the player with the container id and window
	 * title
	 *
	 * @param player         The player to send the packet to
	 * @param containerId    The container id to open
	 * @param inventoryTitle The title of the inventory to be opened (only works in
