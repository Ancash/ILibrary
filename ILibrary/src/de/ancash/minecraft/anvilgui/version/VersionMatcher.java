...
public class VersionMatcher {
	 ...
	 * @throws IllegalStateException If the version wrapper failed to be
	 *                               instantiated or is unable to be found
	 */
	public VersionWrapper match() {
		...
		try {
			...
			throw new IllegalStateException("Failed to instantiate version wrapper for version " + serverVersion,
					exception);
		} catch (ClassNotFoundException exception) {
			throw new IllegalStateException("AnvilGUI does not support server version \"" + serverVersion + "\"",
					exception);
		}
	}
